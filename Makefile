default:
	...
	cd packages/overledger-search && yarn run build && cd ../..
	cd packages/overledger-core && yarn run build && cd ../..
	cd packages/overledger-dlt-corda && yarn run build && cd ../..
	cd packages/overledger-dlt-hyperledger_fabric && yarn run build && cd ../..
