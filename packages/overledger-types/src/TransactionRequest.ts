 ...
 * @property {Object} subType - further details on the action this transaction is performing (for example: valueTransfer, smartContractDeploy, smartContractInvocation,....), the options of which are explicitly defined in the DLT specific transactionRequest object
