...
exports.utcNow = exports.cltvCheckSigOutput = exports.buildRedeemScript = void 0;
...
function buildRedeemScript(publicKeyA, publicKeyB, lockTime) {
    var redeemScript = "OP_IF\n    " + bitcoin.script.number.encode(lockTime).toString('hex') + "\n    OP_CHECKLOCKTIMEVERIFY\n    OP_DROP\nOP_ELSE\n    " + publicKeyB.toString('hex') + "\n    OP_CHECKSIGVERIFY\nOP_ENDIF\n" + publicKeyA.toString('hex') + "\nOP_CHECKSIG";
    return redeemScript;
}
exports.buildRedeemScript = buildRedeemScript;
function cltvCheckSigOutput(redeemScript) {
    return bitcoin.script.fromASM(redeemScript
        .trim()
        .replace(/\s+/g, ' '));
}
exports.cltvCheckSigOutput = cltvCheckSigOutput;
function utcNow() {
