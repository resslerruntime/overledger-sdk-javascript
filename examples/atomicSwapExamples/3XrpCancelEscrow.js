    ...
    const signedTransactions = await overledger.sign([
      {
        ...
        subType: { name: TransactionXRPSubTypeOptions.ESCROW_CANCEL },
        ...
        extraFields: {
          ...
          atomicSwapParameters: {
            ...
            escrowSequence: '335', //The sequence number of the escrow creation transaction. This can be either found from the transaction search using Overledger's search package or from a testnet explorer online
          }
        },
      },]);
